...
from seo_parser.libs import Moz
...
class TestSeoParser:
    ...
    def seo_site_browser(self, mock_browser_client):
        seo_site = Moz(browser_client=mock_browser_client())
        return seo_site

    def test_serialize_with_value(self, seo_site_browser):
        """
        Scenario: Test serialization of Moz instance with a specified
        value.
        When setting a value and serialize_data for a Moz instance.
        ...
        expected_result = {
            "key": "data",
            "values": {"layout": {"mock_key": "mock_value"}, "value": 0},
        }
